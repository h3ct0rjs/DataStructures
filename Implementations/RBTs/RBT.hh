...
hasLeft()
hasRigth()
setColor() : True if node  is Red, Black is False
*/
#include <cassert>
#include <iostream>
#include <stack>
...
private:
  ...
  public:
    ...
    void  setColor(bool value){ color=value;}      //This will let me put the proper color.
